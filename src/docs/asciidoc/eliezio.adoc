...
:cal: &nbsp; icon:calendar-alt[set=fas,size=0.75x,role=blue]
...
[.subtitle]
icon:envelope[set=fas,role=blue] link:mailto:eliezio@pm.me[eliezio@pm.me] | icon:whatsapp[set=fab,role=blue] +353 87 349 6688 | icon:linkedin[set=fab,role=blue] link:https://linkedin.com/in/eliezio[linkedin.com/in/eliezio] | icon:map-marker[set=fa,role=blue] link:+++https://www.google.com/maps/place/Athlone,+Co.+Westmeath/@52.3873731,-7.4592552,7z/+++[Athlone, Ireland]
