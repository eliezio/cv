...
:cal: &nbsp; icon:calendar-alt[set=fas,size=0.75x,role=icon]
...
[.subtitle]
icon:envelope[set=fas,role=icon] link:mailto:eliezio@pm.me[eliezio@pm.me] | icon:whatsapp[set=fab,role=icon] +353 87 349 6688 | icon:linkedin[set=fab,role=icon] link:https://linkedin.com/in/eliezio[linkedin.com/in/eliezio] | icon:map-marker[set=fa,role=icon] link:+++https://www.google.com/maps/place/Athlone,+Co.+Westmeath/@52.3873731,-7.4592552,7z/+++[Athlone, Ireland]
