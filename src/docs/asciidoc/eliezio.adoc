...
:ext-link: icon:external-link-alt[set=fas,size=0.85x,role=light]
...
[.subtitle]
icon:envelope[set=fas,role=icon] link:mailto:eliezio@pm.me[eliezio@pm.me] | icon:whatsapp-square[set=fab,role=icon] +353 87 349 6688 | icon:linkedin[set=fab,role=icon] link:https://linkedin.com/in/eliezio[linkedin.com/in/eliezio] | icon:map-marker-alt[set=fas,role=icon] link:+++https://www.google.com/maps/place/Athlone,+Co.+Westmeath/@52.3873731,-7.4592552,7z/+++[Athlone, Ireland]
...
Contributed to the company’s cloud transformation initiative, focusing on the migration of cryptographic infrastructure from IBM z/OS ICSF to cloud-based HSM solutions.
